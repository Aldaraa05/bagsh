                ...
                <div className="filter-section">
                        ...
                        <div className="filter-section">
                            ...
                            <div className="filter-tags">
                                ...
                                {dedCategories.map((subCategory) => (
                                    <button
                                        key={subCategory}
                                        className={`filter-tag ${activeSubCateg === subCategory ? 'active' : ''}`}
                                        onClick={() => {
                    ...
                    {activeSubCateg && (
                        <div className="filter-section">
                            ...
                            <div className="filter-tags">
                                <button
                                    className={`filter-tag ${!activeSubjectGroup ? 'active' : ''}`}
                                ...
                                {subjectGroups.map((subject) => (
                                    <button
                                        key={subject}
                                        className={`filter-tag ${activeSubjectGroup === subject ? 'active' : ''}`}
